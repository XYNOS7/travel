...
function sceneTwo() {
  ...
  // Redirect to new page after animations complete
  tl.add(() => {
    window.location.href = "DESTINATION.html"; // Replace with your page URL
  });

  return tl;
}

// Master timeline without overlap
const master = new TimelineMax({ paused: true });
master.add(sceneOne());
master.add(sceneTwo()); // Remove negative overlap for smooth transition
